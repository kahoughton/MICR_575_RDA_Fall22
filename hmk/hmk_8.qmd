...
**Answer**: It does look like the X balls have a different mean of 9 while the y balls have a mean around 7.5 Additionally, the SD of X balls is 3.31 and Y balls is around 2.03
...
**Answer**: Looks like all the data have the same mean and sd which probably is not true.. most likely I messed up the analysis. .
